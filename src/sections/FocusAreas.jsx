...
const services = [
  {
    title: "Talent Detection",
    subtitle: "Discover hidden potential",
    image: "/talent1.png",
    description:
      "We help young people discover and demonstrate their talents through auditions, assessments and creative activities.",
    activities: [
      "Talent discovery",
      "Auditions",
...

  {
    ...
    subtitle: "Turn potential into ability",
    image: "/talent2.png",
    description:
      "We develop young people's skills through practical training, coaching and mentorship.",
    disciplines: ["Drama", "Music", "Dance", "Fashion"],
    goal:
      "Helping young people move from potential to performance, confidence and opportunity.",
  },

  {
    title: "Education Through Arts",
    subtitle: "Learning beyond the classroom",
    image: "/dance4.png",
    description:
      "We use drama, music, dance and fashion to make learning creative, practical and memorable.",
    benefits: [
      "Communication",
      "Confidence",
      "Creativity",
...

  {
    ...
    subtitle: "Arts for positive change",
    image: "/new.png",
    description:
      "We use creative arts to bring young people, schools, parents and communities together.",
    activities: [
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <span className="inline-block rounded-full bg-green-100 px-4 py-1.5 text-xs font-bold uppercase tracking-wider text-green-700">
            What We Do
          </span>
          ...
          <p className="mt-4 text-sm leading-6 text-slate-600 sm:text-base">
            We discover talent, develop potential and use creative arts to
            ...
            >
              ...
              <div className="relative h-40 overflow-hidden sm:h-44">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://placehold.co/600x400/eaf7ef/166534?text=Improve+Education";
                  }}
                />
              ...
              <div className="p-5">
                ...
                {/* Talent Detection */}
                {service.title === "Talent Detection" && (
                  <div className="mt-4">
                ...
                {/* Talent Development */}
                {service.title === "Talent Development" && (
                  <div className="mt-4">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      {service.disciplines.map((item) => (
                        <div
                          key={item}
                          className="rounded-lg bg-green-50 px-3 py-2 text-center text-xs font-semibold text-green-700"
                        >
                          {item}
                        </div>
                      ))}
                ...
                {service.title === "Education Through Arts" && (
                  <div className="mt-4">
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-2">
                      {service.benefits.map((item) => (
                        <div
                          key={item}
                          className="flex items-center gap-2 rounded-lg bg-green-50 px-2 py-2 text-xs font-medium text-green-700"
                        >
                          <span>✓</span>
                          <span>{item}</span>
                        </div>
                ...
                {service.title === "Community Mobilization" && (
                  <div className="mt-4">
              ...
              {/* Bottom Accent */}
              <div className="h-1 bg-gradient-to-r from-green-600 to-blue-600" />
        ...
        {/* Bottom Text */}
        <p className="mt-10 text-center text-xs font-medium text-slate-500 sm:text-sm">
          Discovering talent • Developing potential • Educating through arts
