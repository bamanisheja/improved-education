...
const menuItems = [
...

  {
    ...
    href: "#services",
    dropdown: [
      { name: "Academic Support & Tutoring", href: "#services" },
      { name: "Teacher Training", href: "#services" },
      { name: "Youth Empowerment", href: "#services" },
      { name: "Girls' Empowerment & Inclusion", href: "#services" },
      { name: "Talent Development", href: "#services" },
      { name: "Guidance & Mentorship", href: "#services" },
      { name: "Digital Learning", href: "#services" },
      { name: "Education Research", href: "#services" },
      { name: "Parent & Community Engagement", href: "#services" },
      { name: "Creative Arts & Language", href: "#services" },
    ],
  },

  {
    ...
    href: "#focus",
    dropdown: [
      { name: "Quality Education", href: "#focus" },
      { name: "Teacher Development", href: "#focus" },
      { name: "Youth Empowerment", href: "#focus" },
      { name: "Girls' Education", href: "#focus" },
      { name: "Digital Learning", href: "#focus" },
      { name: "Talent Development", href: "#focus" },
      { name: "Community Engagement", href: "#focus" },
      { name: "Education Innovation", href: "#focus" },
    ],
  },
